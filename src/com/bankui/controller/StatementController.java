...
public class StatementController {
	...
	public String processStatement(@RequestParam("startDate") String startDate, 
		 ...
		 * 1. path variable : localhost:8083/statement/startDate/endDate
		 * 2. query params : localhost:8083/statement?startDate=<startDate>&endDate=<endDate>
		...
		String url="http://localhost:8083/statement/"+ startDate +"/" + endDate;
